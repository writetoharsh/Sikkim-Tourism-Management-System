...
<body>
    ...
    <div class="jumbotron ">
        <div class="container text-center bg-light pt-5 pb-1">
            <hr>
            <h1>
                <span class="bg-success" style="color:cornsilk; padding: 6px; border-radius:5px">Successfully</span>
                <u>Registered</u>!
            </h1>
            <div class="text-center mt-5">
                <a href="login.php" class="btn btn-outline-warning">
                    <span class="rounded p-3" style="color:white; background-color: blue;">Login...</span>
